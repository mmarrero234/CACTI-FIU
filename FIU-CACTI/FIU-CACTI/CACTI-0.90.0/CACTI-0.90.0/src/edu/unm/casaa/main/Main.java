...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        /*
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_16x16.png")));
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_24x24.png")));
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_32x32.png")));
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_48x48.png")));
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_64x64.png")));
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_96x96.png")));
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_128x128.png")));
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_256x256.png")));
        mainStage.getIcons().add(new Image(Main.class.getResourceAsStream("file:/media/windows.iconset/icon_512x512.png")));
*/
